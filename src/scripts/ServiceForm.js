...
//Event listener gets the data from the form and adds it to an object. Then 
//it runs the function sendRequest with the object as a parameter in order to send
//this transient data to the API.
